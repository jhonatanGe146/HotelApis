"""
Django settings for hotelperseo project.
...
SECRET_KEY = 'django-insecure-)vtla#^uxzy9q#8l7$1aq*_ck8%gv99d_tf_or89#moqo7fz+h'
...
WSGI_APPLICATION = 'hotelperseo.wsgi.application'
...
STATICFILES_DIRS = ['hotelperseo/static',]
